...
An Odoo 19.0 module by **AgenticBrains** that turns your Odoo instance into a native
Model Context Protocol (MCP) server, so AI assistants can securely search, read,
create, update and delete records through natural language.
