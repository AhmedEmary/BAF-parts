...
The **AgenticBrains MCP Server** module enables AI assistants to securely access and
interact with your Odoo data through the Model Context Protocol (MCP). The module speaks MCP natively: it
...
- **Claude Code (CLI)**:
  ...
  .. code-block:: bash
     ...
     claude mcp add --transport http agenticbrains-odoo https://your-company.odoo.com/mcp
...
.. code-block:: bash
   ...
   claude mcp add --transport http agenticbrains-odoo \
...
For support, reach out to info@agenticbrain.tech
