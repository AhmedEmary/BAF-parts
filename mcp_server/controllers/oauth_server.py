...
# AgenticBrains-branded public URLs surfaced in the OAuth discovery documents
# (RFC 8414 optional fields) and in the RFC 9728 protected-resource metadata.
# Kept as constants so a fork can rebrand every user-visible discovery hint by
# editing three lines.
AB_DOCUMENTATION_URL = "https://agenticbrain.tech/docs/mcp"
AB_PRIVACY_URL = "https://agenticbrain.tech/legal/privacy"
AB_TERMS_URL = "https://agenticbrain.tech/legal/terms"
...
class OAuthMetadataController(http.Controller):
    ...
    def protected_resource_metadata(self, **kwargs):
        ...
        metadata = {
            ...
            # AgenticBrains-specific hints (RFC 9728 extension points):
            # a human-readable name and a pointer to the operator docs so
            # discovery clients can display something more meaningful than
            # the bare URL.
            "resource_name": "AgenticBrains MCP Server for Odoo",
            "resource_documentation": AB_DOCUMENTATION_URL,
        }
    ...
    def authorization_server_metadata(self, **kwargs):
        ...
        metadata = {
            ...
            "scopes_supported": SUPPORTED_SCOPES,
            # RFC 8414 optional fields identifying the AgenticBrains operator
            # and pointing at the human docs / policies. Consent-screen
            # clients like Claude.ai will surface these to the end user.
            "service_documentation": AB_DOCUMENTATION_URL,
            "op_policy_uri": AB_PRIVACY_URL,
            "op_tos_uri": AB_TERMS_URL,
        }
        return request.make_json_response(metadata)
